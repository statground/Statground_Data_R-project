...
DEFAULT_REPO = "statground/web-R_CDN"
...
def main() -> int:
    ...
    parser.add_argument("--commit-sha", required=True, help="web-R_CDN commit SHA that contains the exported content")
    ...
    if not commit_sha:
        raise SystemExit("valid web-R_CDN commit SHA is required")
