DROP TABLE IF EXISTS Data_R_Blogger_Log.mv_kafka_webr_events_to_board ON CLUSTER statground_cluster;

CREATE MATERIALIZED VIEW Data_R_Blogger_Log.mv_kafka_webr_events_to_board
ON CLUSTER statground_cluster
TO Data_R_Blogger_Service.board
AS
SELECT
...
WHERE k.event_type = 'webr.rblogger.board.v1';

ALTER TABLE Data_R_Blogger_Log.mv_kafka_webr_events_to_board
ON CLUSTER statground_cluster
MODIFY COMMENT 'Materialized view from Kafka webr.rblogger.board.v1 events to Data_R_Blogger_Service.board';
