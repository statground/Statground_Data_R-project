DROP TABLE IF EXISTS Data_R_Blogger_Log.mv_kafka_webr_events_to_log ON CLUSTER statground_cluster;

CREATE MATERIALIZED VIEW Data_R_Blogger_Log.mv_kafka_webr_events_to_log
ON CLUSTER statground_cluster
TO Data_R_Blogger_Log.log
AS
SELECT
...
WHERE k.event_type = 'webr.rblogger.log.v1';

ALTER TABLE Data_R_Blogger_Log.mv_kafka_webr_events_to_log
ON CLUSTER statground_cluster
MODIFY COMMENT 'Materialized view from Kafka webr.rblogger.log.v1 events to Data_R_Blogger_Log.log';
